export const translations = {
    es: {
        ...
        servicesMktTitle: "Saborea el éxito en el mundo digital con nuestro análisis y desarrollo de metodologías prácticas.",
        servicesMktCopy: "¡Convierte tu marca en un plato irresistible con nuestros servicios de Social Media Marketing! Nuestro equipo de expertos en redes sociales te brindará consultoría personalizada para conectar con tu comunidad objetivo. Ahorra tiempo y deja en nuestras manos la creación de contenido y la moderación. Nosotros nos encargamos de hornear tus ideas y servirlas en bandeja, para que puedas enfocarte en lo que mejor sabes hacer. ¡Deja que el aroma de tu marca se esparza en las redes sociales y conquista a tus seguidores!",
