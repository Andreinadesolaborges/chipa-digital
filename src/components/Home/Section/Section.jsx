    ...
    return (
        <>
            <div className="section-home" id="s1">
                ...
                <motion.h2 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ ease: "easeOut", duration: 1 }} className="section-text">{texts.sectionHome1p2}</motion.h2>
                <Downarrow id={"s2"} />
            </div>
            <div className="section-home-2" id="s2">
                <div className="img-text-flex">
                    ...
                    <div className="text-block">
                        ...
                        <motion.h4 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ ease: "easeOut", duration: 1 }} className="text-section-home-2 bold">{texts.sectionHome3p1}</motion.h4>
                        <motion.h4 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ ease: "easeOut", duration: 1 }} className="text-section-home-2">{texts.sectionHome3p2}</motion.h4>
                        <motion.h4 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ ease: "easeOut", duration: 1 }} className="text-section-home-2 bold">{texts.sectionHome3p3}</motion.h4>
                        <motion.h4 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ ease: "easeOut", duration: 1 }} className="text-section-home-2">{texts.sectionHome3p4}</motion.h4>
                        <motion.h4 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ ease: "easeOut", duration: 1 }} className="text-section-home-2 bold">{texts.sectionHome3p5}</motion.h4>
                        <motion.h4 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ ease: "easeOut", duration: 1 }} className="text-section-home-2">{texts.sectionHome3p6}</motion.h4>
                    </div>
                </div>
            ...
            <div className="section-home-3" id="s3">
                ...
                <motion.h4 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ ease: "easeOut", duration: 1 }} className="text-section-home-3">{texts.sectionHome4p2}</motion.h4>
